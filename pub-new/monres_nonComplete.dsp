...
<div style="display:none"> </div>
 <TABLE width=100% cellpadding="0" cellspacing="0">
         <TR>
            <TD class="menusectionHeader" colspan="3">Services &gt; Non-Complete Services (%value countNC%)</TD>
         </TR>
	  ...
	  <TABLE>
			<TR>
				<TD colspan="2">
				<UL>	
				<LI><a href="monres_nonComplete.dsp">Refresh this Page</a>
				</UL>	
				</TD>
			</TR>
		</TABLE>
...
<input type="button" onClick="forceComplete();" value="Force Complete Transactions" name="ForceComplete">
