...
a { color: inherit; text-decoration: none;}
   ...
   <BODY >
	  ...
	  <div style="display:none">
		...
		%invoke ESBMonitoring.metrics.services:getServicesTypes%
			%loop ServicesTypes%				
	  ...
	  <TABLE>
			<TR>
				<TD colspan="2">
				<UL>	
				<LI><a href="overview.dsp">Refresh this Page</a>
				</UL>	
				</TD>
			</TR>
		</TABLE>
      
	  %invoke ESBMonitoring.metrics.userInterface:displayMetricsOverview%
      <TABLE class="tableView" width="100%">
       ...
       %endinvoke%           
                  ...
                  <TR id = "service_stat_row_%value SERVICENAME%">
                    ...
                    <TD align="left" onClick="getServiceType('%value serviceName%')">%value SERVICECOUNT%</TD>
					<TD align="right">%value AVGTIME%</TD>
                    <TD align="right">%value MINTIME%</TD>
                    <TD align="right">%value MAXTIME%</TD>
                  </TR>
