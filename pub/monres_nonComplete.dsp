...
<META HTTP-EQUIV="Expires" CONTENT="-1">
      <TITLE>Non-Complete Transactions
      </TITLE>
...
<body>
%invoke ESBMonitoring.logging.userInterface:displayNonComplete%
	<!-- Page Header -->
	<div class="page-header">
		%invoke ESBMonitoring.logging.userInterface:displayToday%
		<div class="header-content">
			<div>
				<h1 class="page-title">Non Complete Transactions</h1>
				<div class="page-meta">
					<span class="info-badge">%value countNC% Services</span>
				</div>
			</div>
			<a href="monres_nonComplete.dsp" class="outline-button">
	...
	<form id="fcr" method="POST" action="" target="details">
		<div class="form-actions-container">
			<input type="button" onClick="forceComplete();" value="Force Complete Transactions" name="ForceComplete" class="outline-button outline-success-button">
			<input type="button" onClick="resubmit();" value="Resubmit Transactions" name="Resubmit" class="outline-button">
		</div>		
				...
				<tbody>
					...
					<tr class="table-row">
						<td class="table-cell-center">
							<input type="checkbox" name="contextID" id="contextID" value="%value CONTEXTID%">
						</td>
						<td class="table-cell-center">
